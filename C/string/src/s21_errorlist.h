#ifndef S21_ERRORLIST
#define S21_ERRORLIST

#if defined(__linux__)
#define ERRORS LINUX_ERRORS
#define ERROR_COUNT LINUX_ERROR_COUNT
#elif defined(__APPLE__)
#define ERRORS MAC_ERRORS
#define ERROR_COUNT MAC_ERROR_COUNT
#else
#error "Usupported platform"
#endif

#define LINUX_ERROR_COUNT 134
#define LINUX_ERRORS                                                           \
  {                                                                            \
